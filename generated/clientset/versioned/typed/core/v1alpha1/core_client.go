...
import (
	...
	"github.com/wutong-paas/region/generated/clientset/versioned/scheme"
...
// CoreV1alpha1Client is used to interact with features provided by the core.wutong.io group.
type CoreV1alpha1Client struct {
	restClient rest.Interface
}

func (c *CoreV1alpha1Client) BizComponents(namespace string) BizComponentInterface {
	return newBizComponents(c, namespace)
}

func (c *CoreV1alpha1Client) SysComponents(namespace string) SysComponentInterface {
	return newSysComponents(c, namespace)
}
