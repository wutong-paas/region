...
import (
	...
	corecontrollers "github.com/wutong-paas/region/controllers/core"
	webapi "github.com/wutong-paas/region/internal/server"
...
func main() {
	// region restful api server
	go webapi.NewServer().Start()
	...
	if err = (&corecontrollers.BizComponentReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "BizComponent")
		os.Exit(1)
	}
	if err = (&corecontrollers.SysComponentReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
